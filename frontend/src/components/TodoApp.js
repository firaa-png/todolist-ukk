...
// icons
import { FaHome, FaTasks, FaFolder, FaEdit, FaTrash } from "react-icons/fa";
...
// expose the utilities under the original names used in this file
const computeWhenFromDate = computeWhenFromDateUtil;
const formatDateDMY = formatDateDMYUtil;
    ...
    <div className="app-shell font-sans">
      <aside className="sidebar">
        <div className="brand">
          ...
          >
            <Image src="/avatar.jpg" alt="avatar" width={40} height={50} />
          </div>
          <div>
            <div
              style={{
          ...
          {sidebarListsOpen ? (
            <div className="sidebar-lists">
              ...
              {lists && lists.length > 0 ? (
                ...
                <div style={{ color: "var(--foreground)", padding: 10 }}>
                  Belum ada list
                </div>
              )}
            </div>
              ...
              <div className="card done-timeline-inner" style={{ padding: 20 }}>
                ...
                >
                  {doneDateKeys.length === 0 ? (
                    <div style={{ color: "var(--foreground)", padding: 12 }}>
                  ...
                  {selectListOpen ? (
                    ...
                    >
                      ...
                      <div style={{ maxHeight: 220, overflow: "auto" }}>
                        ...
                        {lists.length === 0 ? (
                          <div style={{ padding: 10, color: "var(--foreground)" }}>
                            Belum ada list
                          </div>
                        ) : (
                          lists.map((l) => (
            ...
            >
              <div className="list-section">
                ...
                {todayList.length === 0 ? (
                  <div
                    className="task-row"
                    style={{ justifyContent: "center", color: "var(--foreground)" }}
                  >
        ...
        >
          <div
            ...
            style={{
              ...
              color: "var(--foreground)",
              borderRadius: 8,
              boxShadow: "0 18px 40px rgba(12,18,30,0.08)",
          ...
          >
            ...
            <div style={{ fontSize: 20, fontWeight: 700, marginBottom: 6, color: 'var(--foreground)' }}>
              Yakin ingin menghapus?
            </div>
            <div style={{ color: "var(--foreground)", marginBottom: 16 }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
              ...
              <button
                ...
                style={{
                  ...
                  justifyContent: "center",
                  gap: 8,
                  background: !confirmChecked || confirmLoading ? "#cbd5e1" : "#ef4444",
                  color: "white",
                  padding: "8px 18px",
                  borderRadius: 6,
                  border: "none",
